/*
  ==============================================================================
    ...
    MotionBlockModelParameterManagerEditor.cpp
...
#include "MotionBlockModelParameterManagerEditor.h"

MotionBlockModelParameterManagerEditor::MotionBlockModelParameterManagerEditor(MotionBlockModelParameterManager * manager, bool isRoot) :
	GenericManagerEditor(manager, isRoot),
	pManager(manager)
{
}

void MotionBlockModelParameterManagerEditor::showMenuAndAddItem(bool)
{
