...
MotionBlockModelManagerUI::MotionBlockModelManagerUI(const String &name, UserMotionBlockModelManager * m) :
...
MotionBlockModelManagerUI::~MotionBlockModelManagerUI()
{
}


void MotionBlockModelManagerUI::paint(Graphics & g)
{
...
void MotionBlockModelManagerUI::resized()
{
...
void MotionBlockModelManagerUI::setThumbSize(int value)
{
...
MotionBlockModelUI * MotionBlockModelManagerUI::createUIForItem(MotionBlockModel * i)
{
	return i->createUI();
}
